...
public class AccountContentProvider extends ContentProvider {
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (uM.match(uri)) {
            case ACCOUNTID:
                String idRow = uri.getPathSegments().get(1);
                selection = TransactionDBOpenHelper.ACCOUNT_ID + "=" + idRow;
                break;
            default:
                throw new IllegalArgumentException("Unsuported uri: "+uri.toString());
        }

        int rowsDeleted = database.delete(TransactionDBOpenHelper.ACCOUNT_TABLE, selection, selectionArgs);
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues contentValues, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        int rowsUpdated = database.update(TransactionDBOpenHelper.ACCOUNT_TABLE, contentValues, selection, selectionArgs);
